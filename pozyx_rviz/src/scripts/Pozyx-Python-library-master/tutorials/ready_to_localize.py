...
if __name__ == "__main__":
    ...
    remote_id = 0x6833                 # remote device network ID
    ...
    anchors = [DeviceCoordinates(0x686f, 1, Coordinates(0, 0, 0)),
               DeviceCoordinates(0x6866, 1, Coordinates(870, 0, 0)),
               DeviceCoordinates(0x6831, 1, Coordinates(870, 770, 0)),
               DeviceCoordinates(0x6854, 1, Coordinates(0, 770, 0))]
